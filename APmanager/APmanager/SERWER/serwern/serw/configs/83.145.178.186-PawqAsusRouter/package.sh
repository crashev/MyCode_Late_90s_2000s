...
dhcp-option=6,192.168.1.2,83.145.128.4,83.145.128.1

read-ethers
EOF
#max interfejsu radiowego
...
nvram set wl0_ssid=PawqAsusRouter
# przykladowy wep klucz
...
#ustawienia WPA klienckie - bylo open
nvram set wl0_auth_mode=0
nvram set wl0_wpa_psk=skazaninashawshank
nvram set wl0_wpa_gtk_rekey=3600
nvram set wl0_akm=psk
nvram set wl0_crypto=aes+tkip
nvram set wl0_auth=0
#ustawienia WPA dla WDSU
nvram set wl0_wds_wpa_psk=kluczdlawdsu
nvram set wl0_wds_crypto=aes
nvram set wl0_wds_auth_mode=psk
nvram commit
#wifi
reboot
