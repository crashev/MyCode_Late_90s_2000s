...
#Package ver 1.0
cat > /etc/ethers << EOF
00:0e:2e:6e:8b:5d,id:*	192.168.1.10
00:02:2D:AA:07:c6,id:*	192.168.1.100
00:0f:b0:43:18:92,id:*	192.168.1.101
00:14:85:23:bc:a8,id:*	192.168.1.102
00:0E:2E:6E:8B:4C,id:*	192.168.1.11
00:0e:a6:51:e9:7d,id:*	192.168.1.103
00:12:cf:03:87:22,id:*	192.168.1.104
EOF
wifi;
...
dodaj 192.168.1.10	256	512	10485760
dodaj 192.168.1.100	256	512	10485760
dodaj 192.168.1.101	256	512	10485760
dodaj 192.168.1.102	256	512	10485760
dodaj 192.168.1.11	256	512	10485760
EOF
